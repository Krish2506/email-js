...
export default function Basicemailbutton() {
  function handleSendEmail() {
    const serviceId = "service_xwas95h"; // Replace with your Service ID
    const templateId = "template_7lpqkni"; // Replace with your Template ID
    const publicKey = "qIeNwjL4QAFjhMlyj"; // Replace with your Public Key
